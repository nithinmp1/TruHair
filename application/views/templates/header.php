...
<nav class="navbar navbar-success bg-success navbar-static-top" style="background-color: midnightblue;">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo base_url('dashboard') ?>">My Hotel</a>
    </div>
      ...
      <ul class="nav navbar-nav">
        ...
        */ ?>
        <li class="dropdown" id="topAccountMainNav">
          ...
          <ul class="dropdown-menu">
            <!-- <li id="createStudentNav">
              <a href="<?php // echo base_url('accounting?opt=crtpay') ?>">Create Payment</a></li> -->                        
            <li id="managePayNav"><a href="<?php // echo base_url('accounting?opt=mgpay') ?>">Manage Booking</a></li>                        
